...
const Footer = ({ language }) => {
  ...
  const copyrightText =
    language === 'en'
      ? `© ${currentYear} DevVictor. All rights reserved.`
      : language === 'fr'
      ? `© ${currentYear} DevVictor. Tous droits réservés.`
      : `© ${currentYear} DevVictor. Uburenganzira bwose burinzwe.`;

  return (
    <footer className="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 py-12 transition-colors duration-300">
          ...
          <div className="mb-6 md:mb-0 text-center md:text-left">
            ...
            <p className="max-w-xs text-sm">
              {language === 'en'
                ...
                : language === 'fr'
                ? 'Création de solutions numériques innovantes pour les entreprises du monde entier.'
